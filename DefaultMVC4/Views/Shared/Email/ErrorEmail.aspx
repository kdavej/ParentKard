    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td class="navbar navbar-inverse" align="center">
                ...
                <table width="760px" cellspacing="0" cellpadding="3" class="container">
        ...
        <tr>
            <td bgcolor="#FFFFFF" align="center">
                <table width="760px" cellspacing="0" cellpadding="3" class="container">
                    <tr>
                        <td><h5>Error Has Occurred: <%= ViewData["stacktrace"] %></h5>
                            <p>User: <%= ViewData["UserDetails"] %></p>
                            <p>Requested URL: <%= ViewData["URL"] %></p>
                            <p>Request Scope: <%= ViewData["RequestScope"] %></p>
                            <p>Session Data: <%= ViewData["SessionData"] %></p>
                            <p><%= ViewData["error"] %></p>
                        </td>
                    </tr>
                </table>
